# setup_venv.ps1 - Setup virtual environment for wlf.py (Windows)
...
Write-Host "=== wlf.py - Virtual Environment Setup (Windows) ===" -ForegroundColor Cyan
Write-Host ""
...
Write-Host "Run:      python wlf.py --help" -ForegroundColor White
Write-Host "Or:       wfh --help  (if installed via pip)" -ForegroundColor White
Write-Host ""
Write-Host "Optional extras:" -ForegroundColor Cyan
Write-Host "  pip install wordlistxpl-forge[docs]   # PDF/XLSX/DOCX parsing"
Write-Host "  pip install wordlistxpl-forge[ocr]    # OCR/image text extraction"
Write-Host "  pip install wordlistxpl-forge[full]   # All optional dependencies"
Write-Host ""
