...
Usage (CLI):
  wlf.py phone --country brazil --state SP
  wlf.py phone --country brazil --ddd 11 --type mobile
  wlf.py phone --ddi +1 --prefix "212" --pattern "XXXXXXX"
  wlf.py phone --country usa --area 212
