#!/usr/bin/env bash
# setup_venv.sh - Setup virtual environment for wlf.py
...
echo "=== wlf.py - Virtual Environment Setup ==="
echo ""
...
echo "Run:      python wlf.py --help"
echo "Or:       wfh --help  (if installed via pip)"
echo ""
echo "Optional extras:"
echo "  pip install wordlistxpl-forge[docs]   # PDF/XLSX/DOCX parsing"
echo "  pip install wordlistxpl-forge[ocr]    # OCR/image text extraction"
echo "  pip install wordlistxpl-forge[full]   # All optional dependencies"
